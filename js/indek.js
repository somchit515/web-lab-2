var rowCount = document.getElementsByTagName('table')[0].rows.length - 1;
var footerRow = document.getElementsByTagName('foot')[0].rows[0].cells[0];
footerRow.innerHTML = "Total: " + rowCount + " persons";
var slides = document.querySelectorAll('.slideshow');

var currentSlide = 0;
var slideInterval = setInterval(nextSlide, 5000);

// ฟังก์ชันเลื่อนรูปภาพถัดไป
function nextSlide() {
